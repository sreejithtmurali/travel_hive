...
import 'createtrip_viewmodel.dart';
...
class CreateTripView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<CreateTripViewModel>.reactive(
      ...
      viewModelBuilder: () => CreateTripViewModel(),
    );
  }
  ...
  Widget _buildDropdownCard(CreateTripViewModel model) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 10),
      child: Card(
        elevation: 2,
  ...
  Widget _buildDateFormFieldCard({
    ...
    required CreateTripViewModel model,
  ...
  Widget _buildImagePickerCard(CreateTripViewModel model) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 10),
      child: Card(
        elevation: 2,
          ...
          child: Container(
            ...
            child: Center(
              child: model.selectedImage != null
                ...
                children: [
                  Icon(Icons.image,
                      size: 50, color: ColorConstants.primaryRed),
                  const SizedBox(height: 8),
                  Text(
                    "Upload Trip Image",
                    style: GoogleFonts.roboto(
  ...
  Widget _buildSubmitButton(CreateTripViewModel model, GlobalKey<FormState> formKey,BuildContext context) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
            ...
            if (model.selectedImage == null) {
              ...
              Future.delayed(const Duration(seconds: 2), () async {
               ...
               if(s!){
                 ...
                 ScaffoldMessenger.of(context).showSnackBar(
                   SnackBar(
                     content: Text("Trip creation failed!"),
                     backgroundColor: Colors.green,
                   ),
                 );
               }
